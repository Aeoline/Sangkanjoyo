				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="pb-2 fw-bold">Halo <?php echo $hak_akses;?>!</h2>
							</div>
						</div>
					</div>
				</div>
									...
									<div class="card-body ">
										<div class="row align-items-center">
											...
											<div class="col col-stats ml-3 ml-sm-0">
												...
												<a href="?halaman=sudah_acc_sktm" class="btn btn-primary">Buka</a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											...
											<a href="?halaman=sudah_acc_sku" class="btn btn-primary">Buka</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											...
											<a href="?halaman=sudah_acc_skp" class="btn btn-primary">Buka</a>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="card-body ">
										<div class="row align-items-center">
											...
											<div class="col col-stats ml-3 ml-sm-0">
												...
												<a href="?halaman=belum_acc_sktm" class="btn btn-primary">Buka</a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											...
											<a href="?halaman=belum_acc_sku" class="btn btn-primary">Buka</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											...
											<a href="?halaman=belum_acc_skp" class="btn btn-primary">Buka</a>
										</div>
									</div>
								</div>
							</div>
